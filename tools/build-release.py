...
version = '1.1.0'
out = outdir / f'13-sabri-welcome-intro-animation-{version}.zip'
...
manifest = {
    'plugin': 'Sabri Welcome Intro Animation', 'version': version, 'top_level_folder': top,
...
(root / f'MANIFEST-{version}.json').write_text(json.dumps(manifest, indent=2, ensure_ascii=False) + '\n', encoding='utf-8')
