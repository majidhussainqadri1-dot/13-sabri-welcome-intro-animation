...
check 'runtime configuration integration is restriction-only' "contains '$plugin/includes/class-swi-config.php' 'restrict_runtime_config' && contains '$plugin/includes/class-swi-config.php' 'array_intersect' && contains '$plugin/includes/class-swi-config.php' 'suppressed_prefixes' && contains '$plugin/includes/class-swi-config.php' 'array_merge'"
check 'eligibility integration cannot lift a local denial' "contains '$plugin/includes/class-swi-eligibility.php' 'invalid_filter_result' && contains '$plugin/includes/class-swi-eligibility.php' 'filtered' && contains '$plugin/includes/class-swi-eligibility.php' 'decision'"
...
check 'cross-device preference mutation is authenticated and idempotent' "contains '$plugin/includes/class-swi-rest.php' \"'/preference'\" && contains '$plugin/includes/class-swi-rest.php' 'is_user_logged_in()' && contains '$plugin/includes/class-swi-rest.php' 'swi_pref_'"
