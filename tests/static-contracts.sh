...
check 'runtime integrations cannot lift local kill/privacy/route gates' "grep -q \"restrict_runtime_config\" '$plugin/includes/class-swi-config.php' && grep -q \"array_intersect\" '$plugin/includes/class-swi-config.php' && grep -q \"suppressed_prefixes.*array_values.*array_unique.*array_merge\" '$plugin/includes/class-swi-config.php' && grep -q \"Integration filters are restriction-only\" '$plugin/includes/class-swi-eligibility.php'"
