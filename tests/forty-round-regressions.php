...
swi_test_reset(); $raw = SWI_Config::defaults(); $raw['starts_at'] = '2026-08-07T09:00'; $scheduled = SWI_Config::sanitize( $raw, false ); f13_check( '2026-08-07T04:00:00+00:00' === $scheduled['starts_at'], 'datetime-local input is interpreted in the WordPress Asia/Karachi site timezone before UTC storage' ); $raw['starts_at'] = '2026-02-31T09:00'; $invalid = SWI_Config::sanitize( $raw, false ); f13_check( '' === $invalid['starts_at'], 'invalid calendar datetime is rejected rather than normalized silently' );
